import random
from data.italian_data import italian_vocab_unit_1, italian_vocab_unit_2, italian_duo_1, italian_convo_unit_1
...
def italian_convo_review():
    while True:
        ...
        while unanswered_questions:
            ...
            correct_translations = italian_convo_unit_1[convo_topic].split(", ")  
        ...
        total_questions = len(italian_convo_unit_1)
        correct_percentage = (correct_count / total_questions) * 100
